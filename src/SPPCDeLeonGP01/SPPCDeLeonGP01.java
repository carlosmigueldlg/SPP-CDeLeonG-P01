 ...
 package SPPCDeLeonGP01;
 import java.util.Scanner;
 
 /**
 + *
 + * @author Carlos Miguel De Leon Garcia
Carlos Javier Barragan Carrion
Jose Eduardo de Llano Barragan
Alberto Barnetche Suarez
 * 
 + */
 public class SPPCDeLeonGP01 {
                ...
                switch (opEntrada){
                     case 1:
                      ...
                      case 3:
                          ...
                          mi=kb.nextDouble();
                        km=mi*1.60934;
                          System.out.println("Su resutlado es: " + km + " Kilometros.");
                          break;
                      default:
                         System.out.println("¡Hasta la vista baby!");
                  }break;
